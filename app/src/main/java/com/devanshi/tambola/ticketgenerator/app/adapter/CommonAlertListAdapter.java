...
import com.devanshi.tambola.ticketgenerator.app.model.CommonAlertListModel;
 ...
 */
public class CommonAlertListAdapter extends ArrayAdapter<CommonAlertListModel> {

    private Context mContext;
    private ArrayList<CommonAlertListModel> maritalStatusModels;
    private LayoutInflater inflater;

    public CommonAlertListAdapter(Context context, int resource, ArrayList<CommonAlertListModel> maritalStatusModels) {
    ...
    @Override
    public CommonAlertListModel getItem(int position) {
